...
ENTRYPOINT ["java" ,"-cp","app:app/lib/*","com.peertutor.TutorMgr.TutorMgrApplication"]

# to use for ci cd
# ENTRYPOINT ["java" ,"-cp","app:app/lib/*","com.peertutor.TutorMgr.TutorMgrApplication", "-Dspring.profiles.active=docker"]
